...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "./common.js"
  ...
  export interface AuctionMarketProxyInterface extends Interface {
  ...
  export interface AuctionMarketProxy extends BaseContract {
    
    connect(runner?: ContractRunner | null): AuctionMarketProxy;
    waitForDeployment(): Promise<this>;

    interface: AuctionMarketProxyInterface;
